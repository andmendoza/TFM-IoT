        ...
        <div class="d-flex">
            ...
            <!-- <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect"
                    ...
                    <?php
                        ...
                        switch($lang){
                            case 'en':
                               echo '<img src="'.$baseDef.'assets/images/flags/us.jpg" alt="Header Language" height="16">';
                                break;
                            case 'es':
                               echo '<img src="'.$baseDef.'assets/images/flags/spain.jpg" alt="Header Language" height="16">';
                                break;
                            case 'de':
                               echo '<img src="'.$baseDef.'assets/images/flags/germany.jpg" alt="Header Language" height="16">';
                                break;
                            case 'it':
                               echo '<img src="'.$baseDef.'assets/images/flags/italy.jpg" alt="Header Language" height="16">';
                                break;
                            case 'ru':
                               echo '<img src="'.$baseDef.'assets/images/flags/russia.jpg" alt="Header Language" height="16">';
                                break;
                            default:
                                echo '<img src="'.$baseDef.'assets/images/flags/us.jpg" alt="Header Language" height="16">';
                        }
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?=base_url('/').'/'?>assets/images/users/avatar3.png"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">Administrador</span>
