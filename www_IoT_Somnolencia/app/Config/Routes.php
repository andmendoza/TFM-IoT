...
$routes->post('/login', 'Home::check');
$routes->group('', ['filter' => 'AuthCheck'], function ($routes) {
	$routes->get('/', 'Home::index');
	$routes->get('/logout', 'Home::logout');
	$routes->get('/tracking', 'Home::tracking');
	
	$routes->get('clientes/(:any)/empleados','Clientes::empleados/$1');
	$routes->get('clientes/(:any)/asignaciones','Clientes::asignaciones/$1');
	$routes->get('clientes/(:any)/asignaciones/(:any)/tracking','Clientes::asignaciones_tracking/$1/$2');
	$routes->get('clientes/(:any)/device/(:any)/online','Clientes::device_online/$1/$2');
	$routes->get('clientes/(:any)/device/(:any)/getimagen','Clientes::device_getimagen/$1/$2');
